...
namespace Gundo\Imagine\Ui\Component\Listing\Column;
 ...
 */
class ImagineBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Imagine';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'imagine/imagine/edit';
    private const DELETE_URL_PATH = 'imagine/imagine/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[ImagineInterface::IMAGINE_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [ImagineInterface::IMAGINE_ID => $item[ImagineInterface::IMAGINE_ID]];
